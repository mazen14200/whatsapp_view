...
namespace Bnan.Inferastructure.Migrations
{
    ...
    [Migration("20230823111405_IgnoreColOfUser")]
    partial class IgnoreColOfUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bnan.Core.Models.CrMasRenterInformation", b =>
                {
            ...
            modelBuilder.Entity("Bnan.Core.Models.CrMasUserEvaluationRenter", b =>
                {
            ...
            modelBuilder.Entity("Bnan.Core.Models.CrMasRenterInformation", b =>
                {
                    b.HasOne("Bnan.Core.Models.CrMasSupAccountBank", "CrMasRenterInformationBankNavigation")
                    ...
                    b.HasOne("Bnan.Core.Models.CrMasSupRenterDrivingLicense", "CrMasRenterInformationDrivingLicenseTypeNavigation")
                        .WithMany("CrMasRenterInformations")
                    ...
                    b.HasOne("Bnan.Core.Models.CrMasSupRenterGender", "CrMasRenterInformationGenderNavigation")
                        .WithMany("CrMasRenterInformations")
                        .HasForeignKey("CrMasRenterInformationGender")
                        .HasConstraintName("FK_CR_Mas_Renter_Information_CR_Mas_Sup_Renter_Gender");

                    b.HasOne("Bnan.Core.Models.CrMasSupRenterIdtype", "CrMasRenterInformationIdtrypeNavigation")
                        .WithMany("CrMasRenterInformations")
                        .HasForeignKey("CrMasRenterInformationIdtrype")
                        .HasConstraintName("FK_CR_Mas_Renter_Information_CR_Mas_Sup_Renter_IDType");

                    b.HasOne("Bnan.Core.Models.CrMasSupRenterProfession", "CrMasRenterInformationJobsNavigation")
                        .WithMany("CrMasRenterInformations")
                        .HasForeignKey("CrMasRenterInformationJobs")
                        .HasConstraintName("FK_CR_Mas_Renter_Information_CR_Mas_Sup_Renter_Professions");

                    b.HasOne("Bnan.Core.Models.CrMasSupRenterNationality", "CrMasRenterInformationNationalityNavigation")
                        .WithMany("CrMasRenterInformations")
                    ...
                    b.HasOne("Bnan.Core.Models.CrMasSupRenterSector", "CrMasRenterInformationSectorNavigation")
                        .WithMany("CrMasRenterInformations")
                        .HasForeignKey("CrMasRenterInformationSector")
                        .HasConstraintName("FK_CR_Mas_Renter_Information_CR_Mas_Sup_Renter_Sector");

                    b.HasOne("Bnan.Core.Models.CrMasSupRenterEmployer", "CrMasRenterInformationWorkplaceSubscriptionNavigation")
                        .WithMany("CrMasRenterInformations")
            ...
            modelBuilder.Entity("Bnan.Core.Models.CrMasUserEvaluationRenter", b =>
                {
                    b.HasOne("Bnan.Core.Models.CrMasSysEvaluationType", "CrMasUserEvaluationRenterCodeNavigation")
                    ...
                    b.HasOne("Bnan.Core.Models.CrMasLessorInformation", "CrMasUserEvaluationRenterLessorNavigation")
                        .WithMany("CrMasUserEvaluationRenters")
                        .HasForeignKey("CrMasUserEvaluationRenterLessor")
                        .HasConstraintName("CR_Mas_User_Evaluation_Renter_CR_Mas_Lessor_Information");

                    b.HasOne("Bnan.Core.Models.CrMasUserInformation", "CrMasUserEvaluationRenterUserNavigation")
                        .WithMany("CrMasUserEvaluationRenters")
