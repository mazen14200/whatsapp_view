...
namespace Bnan.Core.Models
{
    public partial class CrCasLessorMembership
    {
        ...
        public string? CrCasLessorMembershipConditionsChoice { get; set; }
        public int? CrCasLessorMembershipConditionsNo { get; set; }
        public string? CrCasLessorMembershipConditionsGroup { get; set; }
        public string? CrCasLessorMembershipConditionsPicture { get; set; }

        public virtual CrMasSupMembershipChoice? CrCasLessorMembershipConditionsChoiceNavigation { get; set; }
