...
namespace Bnan.Core.Interfaces
{
    public interface IFeedBoxBS
    {
        ...
        Task<bool> AddAccountReceipt(string AdmintritiveNo, string lessorCode, string UserLogin, string BranchCode, decimal Creditor, string reasons,string ArPdf,string EnPdf);
