    ...
    $(this).on('change', function (e) {
      ...
      filesArr.forEach(function (f, index) {
        ...
        reader.onload = function (e) {
          ...
          imgWrap.append(html);
          ExpensesArray.push({f,url: e.target.result
          }
            ); 
    ...
    $(this).on('change', function (e) {
      ...
      filesArr.forEach(function (f, index) {
        ...
        reader.onload = function (e) {
          ...
          imgWrap.append(html);
          compensationArray.push({f, url: e.target.result
        }); 
      ...
      filesArr.forEach(function (f, index) {
        ...
        reader.onload = function (e) {
          var html =
            ...
            "' data-file='" +
            f.name +
            "' class='img-bg'><div class='upload__img-close3'><img src='delete.png'></div></div></div>";
          imgWrap.append(html);
          examinationArray.push({f,             url: e.target.result
          }); 
