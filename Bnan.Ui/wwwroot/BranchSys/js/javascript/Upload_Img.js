...
function canvasBehavoiur() {
  ...
  var currX = 0;
  var currY = 0;
  var color = '#39629C'; // Change this to the desired color
  var fontSize = 4; // Change this to the desired font size
  ...
  function drawLine(x0, y0, x1, y1) {
    ...
    ctx.lineWidth = fontSize; // Set the line width as the font size
    ctx.stroke();
    ctx.closePath();
  }
