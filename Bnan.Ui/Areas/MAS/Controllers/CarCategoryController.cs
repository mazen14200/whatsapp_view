        ...
        public async Task<IActionResult> AddCarCategory(CarCategoryVM CarCategorys)
        {
            ...
            if (ModelState.IsValid)
            {
                if (CarCategorys != null)
                {
                    ...
                    var (mainTask, subTask, system, currentUser) = await SetTrace("107", "1107006", "1");
                    var RecordAr = CarCategoryVMT.CrMasSupCarCategoryArName;
                    var RecordEn = CarCategoryVMT.CrMasSupCarCategoryEnName;
        ...
        public async Task<IActionResult> Edit(CarCategoryVM model)
        {
            ...
            if (user != null)
            {
                if (model != null)
                {
                    ...
                    // SaveTracing
                    var (mainTask, subTask, system, currentUser) = await SetTrace("107", "1107006", "1");
                    var RecordAr = contract.CrMasSupCarCategoryArName;
                    var RecordEn = contract.CrMasSupCarCategoryEnName;
