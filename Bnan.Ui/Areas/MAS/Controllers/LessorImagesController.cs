            ...
            if (lessorImages != null)
            {
                ...
                foreach (var item in formData.Files)
                {
                    ...
                    if (file != null && Name != null)
                    {
                        ...
                        if (Name == "ContractExtensionCard") lessorImages.CrMasLessorImageContractExtensionCard = await file.SaveImageAsync(_webHostEnvironment, foldername, NewName, ".png", lessorImages.CrMasLessorImageContractExtensionCard);
