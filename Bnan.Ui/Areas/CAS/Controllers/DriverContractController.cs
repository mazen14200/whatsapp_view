...
namespace Bnan.Ui.Areas.CAS.Controllers
{
        ...
        public class DriverContractController : BaseController
        {
            ...
            var DriverContractAll = _unitOfWork.CrCasRenterPrivateDriverInformation.FindAll(x => currentUser.CrMasUserInformationLessor == x.CrCasRenterPrivateDriverInformationLessor && x.CrCasRenterPrivateDriverInformationLastContract != null && x.CrCasRenterPrivateDriverInformationContractCount > 0).ToList();
        ...
        [HttpGet]
            public async Task<PartialViewResult> GetDriverContractByStatusAsync(string status)
            {
                ...
                if (status == Status.All)
                    ...
                    var DriverContractbyStatusAll = _unitOfWork.CrCasRenterPrivateDriverInformation.FindAll(x => currentUser.CrMasUserInformationLessor == x.CrCasRenterPrivateDriverInformationLessor && x.CrCasRenterPrivateDriverInformationLastContract != null && x.CrCasRenterPrivateDriverInformationContractCount > 0).ToList();
                ...
                var DriverContractbyStatus = _unitOfWork.CrCasRenterPrivateDriverInformation.FindAll(x => currentUser.CrMasUserInformationLessor == x.CrCasRenterPrivateDriverInformationLessor && x.CrCasRenterPrivateDriverInformationLastContract != null && x.CrCasRenterPrivateDriverInformationContractCount > 0 && x.CrCasRenterPrivateDriverInformationStatus == status).ToList();
