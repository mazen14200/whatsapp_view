...
namespace Bnan.Ui.Areas.CAS.Controllers
{
        ...
        public class DriverContractController : BaseController
        {
            ...
            public async Task<IActionResult> Index()
            {
                ...
                //var DriverContractAll = _unitOfWork.CrCasRenterContractBasic.GetAll(new[] { "CrCasRenterContractBasic1", "CrCasRenterContractBasic2", "CrCasRenterContractBasic3", "CrCasRenterContractBasic4.CrCasRenterLessorNavigation", "CrCasRenterContractBasicCarSerailNoNavigation", "CrCasRenterContractBasicNavigation", "CrCasRenterContractBasicSectorNavigation" }).Where(x => x.CrCasRenterContractBasic3?.CrCasRenterPrivateDriverInformationContractCount > 0 && x.CrCasRenterContractBasicPrivateDriverId != null);
                var DriverContractAll = _unitOfWork.CrCasRenterContractBasic.GetAll(new[] { "CrCasRenterContractBasic1", "CrCasRenterContractBasic2", "CrCasRenterContractBasic3", "CrCasRenterContractBasic4.CrCasRenterLessorNavigation", "CrCasRenterContractBasicCarSerailNoNavigation", "CrCasRenterContractBasicNavigation", "CrCasRenterContractBasicSectorNavigation" }).Where(x => x.CrCasRenterContractBasicPrivateDriverId != null && currentUser.CrMasUserInformationLessor == x.CrCasRenterContractBasicLessor);
                ...
                if (status == Status.All)
                    {
                        ...
                        var DriverContractbyStatusAll = _unitOfWork.CrCasRenterContractBasic.FindAll(l => l.CrCasRenterContractBasic3.CrCasRenterPrivateDriverInformationStatus == Status.Hold || l.CrCasRenterContractBasicStatus == Status.Active || l.CrCasRenterContractBasicStatus == Status.Rented, new[] { "CrCasRenterContractBasic1", "CrCasRenterContractBasic2", "CrCasRenterContractBasic3", "CrCasRenterContractBasic4.CrCasRenterLessorNavigation", "CrCasRenterContractBasicCarSerailNoNavigation", "CrCasRenterContractBasicNavigation", "CrCasRenterContractBasicSectorNavigation" }).Where(x => x.CrCasRenterContractBasicPrivateDriverId != null && x.CrCasRenterContractBasic3?.CrCasRenterPrivateDriverInformationContractCount > 0 && currentUser.CrMasUserInformationLessor == x.CrCasRenterContractBasicLessor).ToList();

                        return PartialView("_DataTableDriverContract", DriverContractbyStatusAll);
                    }
                    var DriverContractbyStatus = _unitOfWork.CrCasRenterContractBasic.FindAll(l => l.CrCasRenterContractBasic3.CrCasRenterPrivateDriverInformationStatus == status , new[] { "CrCasRenterContractBasic1", "CrCasRenterContractBasic2", "CrCasRenterContractBasic3", "CrCasRenterContractBasic4.CrCasRenterLessorNavigation", "CrCasRenterContractBasicCarSerailNoNavigation", "CrCasRenterContractBasicNavigation", "CrCasRenterContractBasicSectorNavigation" }).Where(x => x.CrCasRenterContractBasicPrivateDriverId != null && x.CrCasRenterContractBasic3?.CrCasRenterPrivateDriverInformationContractCount > 0 && currentUser.CrMasUserInformationLessor == x.CrCasRenterContractBasicLessor).ToList();
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            //var contract = _unitOfWork.CrCasRenterContractBasic.FindAll(l => l.CrCasRenterContractBasic3?.CrCasRenterPrivateDriverInformationId == id, new[] { "CrCasRenterContractBasic1", "CrCasRenterContractBasic2", "CrCasRenterContractBasic3", "CrCasRenterContractBasic4.CrCasRenterLessorNavigation", "CrCasRenterContractBasicCarSerailNoNavigation", "CrCasRenterContractBasicNavigation", "CrCasRenterContractBasicSectorNavigation" }).Where(x => x.CrCasRenterContractBasicPrivateDriverId != null).Where(x => x.CrCasRenterContractBasic3?.CrCasRenterPrivateDriverInformationContractCount > 0).ToList();
            var contract = _unitOfWork.CrCasRenterContractBasic.FindAll(l => l.CrCasRenterContractBasic3.CrCasRenterPrivateDriverInformationId == id, new[] { "CrCasRenterContractBasic1", "CrCasRenterContractBasic2", "CrCasRenterContractBasic3", "CrCasRenterContractBasic4.CrCasRenterLessorNavigation", "CrCasRenterContractBasicCarSerailNoNavigation", "CrCasRenterContractBasicNavigation", "CrCasRenterContractBasicSectorNavigation" }).Where(x => x.CrCasRenterContractBasicPrivateDriverId == id && currentUser.CrMasUserInformationLessor == x.CrCasRenterContractBasicLessor && x.CrCasRenterContractBasicStatus != Status.Extension && x.CrCasRenterContractBasic3?.CrCasRenterPrivateDriverInformationContractCount > 0).OrderBy(x => x.CrCasRenterContractBasicNo).ThenByDescending(t => t.CrCasRenterContractBasicCopy).ToList();
